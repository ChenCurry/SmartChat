...
CREATE TABLE `shared_file` (
  ...
  `FORE_NAME` varchar(100) NOT NULL COMMENT '前端显示的文件名',
  `BACK_NAME` varchar(150) NOT NULL COMMENT '后端存储的文件名',
  PRIMARY KEY  (`ID`)
...
ALTER TABLE STAFF CHANGE NAME NAME VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_general_ci;
