...
public class StaffDao {
	...
	public List<Staff> selectAll(){
		...
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.selectAll";
	...
	public Staff selectOne(int id){
		/*获取session*/
		SqlSession session = Mybatisutil.getSqlSession();
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.selectByPrimaryKey";
	...
	public Staff selectOne(String code){
		/*获取session*/
		SqlSession session = Mybatisutil.getSqlSession();
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.selectByCode";
	...
	public int updateByPrimaryKey(Staff staff){
		...
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.updateByPrimaryKeySelective";
	...
	public int deleteStaffByPrimaryKey(int staffId){
		...
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.deleteByPrimaryKey";
	...
	public int deleteStaffByCode(String code){
		...
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.deleteByCode";
	...
	public int insertRecord(Staff staff){
		...
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.insertSelective";
	...
	public int updateHeadUrlById(Staff staff){
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.updateHeadUrl";
		int res = session.update(statement, staff);
		return res;
	}
	...
	public int updateStateById(Staff staff){
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.StaffMapper.updateState";
		int res = session.update(statement, staff);
		return res;
	}
}
