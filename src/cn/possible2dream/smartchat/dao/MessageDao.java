...
public class MessageDao {
	...
	public int insertRecord(Message message){
		...
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.insertSelective";
	...
	public List<Message> selectAll(){
		...
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.selectAll";
	...
	public List<MessageToFore> selectRecords(){
		SqlSession session = Mybatisutil.getSqlSession();
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.selectRecords";
	...
	public List<MessageToFore> selectRecords300(){
		SqlSession session = Mybatisutil.getSqlSession();
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.selectRecords300";
		List<MessageToFore> messages = session.selectList(statement);
		session.close();
		return messages;
	}
	...
	public List<MessageToFore> selectPrivateRecords(int staffId, int targetId){
		SqlSession session = Mybatisutil.getSqlSession();
		String statament = "cn.possible2dream.smartchat.mapper.MessageMapper.selectPrivateRecords";
	...
	public int deleteByPrimaryKey(Long messageId){
		...
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.deleteByPrimaryKey";
	...
	public int delete(List<Integer> id) {
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.deleteByPrimaryKeys";
	...
	public int deleteByStaff_id(int staff_id){
		...
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.deleteByStaff_id";
	...
	public int updateByPrimaryKey(Message message){
		SqlSession session = Mybatisutil.getSqlSession(true);
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.updateByPrimaryKeySelective";
	...
	public List<MessageToFore> selectPublicTop10(){
		SqlSession session = Mybatisutil.getSqlSession();
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.selectPublicTop10";
	...
	public List<MessageToFore> selectPublicNormal(int number){
		SqlSession session = Mybatisutil.getSqlSession();
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.selectPublicNormal";
	...
	public List<MessageToFore> selectPrivateTop10(int staffId, int targetId){
		SqlSession session = Mybatisutil.getSqlSession();
		String statement = "cn.possible2dream.smartchat.mapper.MessageMapper.selectPrivateTop10";
		Map<String, Integer> map = new HashMap<>();
		map.put("targetId", targetId);
		map.put("staffId", staffId);
