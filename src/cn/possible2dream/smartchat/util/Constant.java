...
import cn.possible2dream.smartchat.action.WebSocketTest;
...
public class Constant {
	...
	public static String SHAREFLRE_LOCATION;//文件存放位置的前缀
	public static String IMG_PATH;//文件存放位置的前缀
	
//	public static String NAMELOGIN="";//来自LoginServlet创建，用以ws连接时session有问题的情况
//	public static String staffIdLogin="";//来自LoginServlet创建，用以ws连接时session有问题的情况
